...
public class MessagesConfig {
	...
	public static String COMMAND_TRAM_USAGE_ASSIGNTRAIN = "&c Usage: /qav tracks assigntrain <id>";
	public static String COMMAND_TRAM_NO_VEHICLE_FOUND = "&c No vehicle found. Sit in a train or look at it, then run the command again.";
	public static String COMMAND_TRAM_VEHICLE_NOT_TRAIN = "&c That vehicle is not a train.";
	public static String COMMAND_TRAM_TRAIN_ASSIGNED = "&a Assigned train type &f%train%&a to track &f%track%";
	...
	public static String MENU_TRAM_ADD_TRAIN_LORE = "&7Use: &f/qav tracks assigntrain <id>";
	...
	public static void init() {
		...
		COMMAND_TRAM_TRAIN_ASSIGNED = a("Tram.Commands.TrainAssigned", COMMAND_TRAM_TRAIN_ASSIGNED);
